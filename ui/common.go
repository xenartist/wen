...
const APP_NAME_STRING = "wen (1.0.0)"
const PASSWORD_MANAGER_STRING = "Password Manager"
const SOLXEN_CPU_MINER_STRING = "SOL Miner (CPU)"
const TOKEN_HARVEST_STRING = "Token Harvest (LFH)"
const QUIT_STRING = "QUIT(Press 'q' 4 times)"
const AUTHOR_STRING = "by @xen_artist"

var ModuleNames = []string{PASSWORD_MANAGER_STRING, SOLXEN_CPU_MINER_STRING, TOKEN_HARVEST_STRING}
